...
# Thing gpioget $ATOMICPICHIP_ISH_GPIO_0 (without quotes)

# External GPIO
ATOMICPI_ISH_GPIO_0=355
...
# Volume up pin
ATOMIC_GPIO_DFX_2=348
ATOMICPICHIP_GPIO_DFX_2="gpiochip1 7"

# Volume up pin
ATOMIC_GPIO_DFX_4=346
ATOMICPICHIP_GPIO_DFX_4="gpiochip1 5"

# Internal signals
ATOMICPI_I2C_3P3_SDA=478
ATOMICPICHIP_I2C_3P3_SDA="gpiochip0 62"
ATOMICPI_I2C_3P3_SCL=480
ATOMICPICHIP_I2C_3P3_SCL="gpiochip0 66"
